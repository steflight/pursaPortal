...
<?php echo form_open('investments/topup'); ?>
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			...
			<div class="form-group">
				...
				<input type="number" class="form-control" name="amount" placeholder="Number" value="<?php echo $this->session->userdata('client_amount'); ?>">
			</div>

			<div class="form-group">
			  <label for="payout-timeframe">Payouts:</label>
			  <select class="form-control" name="payout" id="payout-timeframe">
			    <option value="<?php echo $this->session->userdata('client_payout'); ?>"> </option>
			...
			<div class="form-group">
			  ...
			  <select class="form-control" name="duration" id="contract-timeframe">
			    <option value="<?php echo $this->session->userdata('client_duration'); ?>"> </option>
